      ...
      builder: (context, constraints) {
        ...
        return GridView.builder(
          ...
          itemBuilder: (context, index) {
            return _NetbarGridCard(netbar: netbars[index], onRefresh: onRefresh);
          },
        );
      },
    );
    ...
    return InkWell(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: Colors.white,
          borderRadius: BorderRadius.circular(24),
          border: Border.all(color: isOnline ? Colors.grey.shade100 : Colors.grey.shade200),
          ...
          children: [
            ...
            Expanded(
              ...
              child: Stack(
                fit: StackFit.expand,
                children: [
                  if (netbar.screenshotUrl != null && netbar.screenshotUrl!.isNotEmpty)
                    Image.network(
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: isOnline ? Colors.green.withOpacity(0.9) : Colors.grey.shade800.withOpacity(0.9),
                        borderRadius: BorderRadius.circular(8),
                        border: Border.all(
                          color: isOnline ? Colors.green.shade400 : Colors.grey.shade700,
                        ),
                  ...
                  if (netbar.remoteStatus?.isActive == true)
                    Positioned(
                      top: 12,
                      right: 12, // Adjusted to right or center based on Vue design
                      child: Container(
                        padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                        decoration: BoxDecoration(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        // Resource Bars
                        _buildResourceBar(LucideIcons.cpu, netbar.serverMetrics?.cpuUsage ?? 0),
                        const SizedBox(height: 6),
                        _buildResourceBar(LucideIcons.hardDrive, netbar.serverMetrics?.ramUsage ?? 0),
                      ],
                    ),
                               ...
                               children: [
                                 InkWell(
                                   ...
                                   child: Padding(
                                     ...
                                     child: Icon(LucideIcons.settings, size: 16, color: Colors.grey.shade400),
                                   ),
                                 ),
                                 const SizedBox(width: 4),
                                 InkWell(
                                   ...
                                   child: Container(
                                     ...
                                     child: const Icon(LucideIcons.monitorPlay, size: 16, color: AppColors.primary),
                                   ),
                                 ),
                               ],
                             ),
