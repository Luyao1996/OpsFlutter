  ...
  Widget _buildCheckUpdateButton() {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            const Icon(LucideIcons.refreshCw, size: 18, color: Color(0xFF2563EB)),
            const SizedBox(width: 12),
            const Text(
              '检查更新',
              style: TextStyle(
  ...
  Widget _buildOverviewTab(String userName, String role, String account,
    ...
    return Column(
      ...
      children: [
        ...
        // 配套软件：iOS 隐藏——App 内引导下载 APK/EXE 触碰 App Store 审核 2.5.2/3.2.2，
        // 且 iOS 用户应从 App Store 获取本 App，无需此入口。Android/桌面端行为不变。
