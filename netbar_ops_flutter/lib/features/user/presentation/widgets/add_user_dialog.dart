...
class _AddUserDialogState extends ConsumerState<AddUserDialog> {
  ...
  void initState() {
    ...
    if (initialId == 0 ||
        (initialId != null && !widget.groups.any((g) => g.id == initialId))) {
      initialId = null;
    }
    _selectedGroupId =
        initialId ?? (widget.groups.isNotEmpty ? widget.groups.first.id : null);
  ...
  Future<void> _handleSave() async {
    ...
    final selectedRole = _selectedRoles.isNotEmpty
