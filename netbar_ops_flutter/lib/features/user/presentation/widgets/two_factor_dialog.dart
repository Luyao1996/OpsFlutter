                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Image.network(
                      ...
                      errorBuilder: (context, error, stackTrace) => const Icon(LucideIcons.qrCode, size: 64, color: Colors.grey),
                    ),
                  ),
                  ...
                  GestureDetector(
                    ...
                    child: const Text(
                      '下载身份验证器',
                      style: TextStyle(fontSize: 12, color: AppColors.iosBlue, decoration: TextDecoration.underline),
                    ),
                  ),
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            _mockSecret,
                            textAlign: TextAlign.center,
                            style: const TextStyle(fontFamily: 'monospace', fontSize: 14, color: Color(0xFF374151)),
                          ),
                        ),
                        InkWell(
                          onTap: _handleCopy,
                          ...
                          child: const Padding(
                            ...
                            child: Icon(LucideIcons.copy, size: 16, color: Colors.grey),
                          ),
                        ),
                      ],
                    ),
                  ...
                  TextField(
                    ...
                    textAlign: TextAlign.center,
                    style: const TextStyle(fontSize: 20, letterSpacing: 8, fontFamily: 'monospace', fontWeight: FontWeight.bold),
                    onChanged: (v) => setState(() {}),
                    decoration: InputDecoration(
                      hintText: '输入 6 位验证码',
                      hintStyle: TextStyle(fontSize: 14, letterSpacing: 0, color: Colors.grey.shade400, fontWeight: FontWeight.normal),
                      counterText: '',
                      filled: true,
                      fillColor: Colors.white,
                      border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: Colors.grey.shade300)),
                      enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: Colors.grey.shade300)),
                      focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: AppColors.iosBlue, width: 2)),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ElevatedButton(
                          onPressed: _codeController.text.length == 6 ? _handleConfirm : null,
                          ...
                          child: Text(widget.user.is2FABound ? '重新绑定' : '确认绑定', style: const TextStyle(fontWeight: FontWeight.w600)),
                        ),
                      ),
                    ],
                  ),
